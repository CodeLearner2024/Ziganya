...
public class AssociationSettingsResponse {
    ...
    public AssociationSettingsResponse(Long id, Double contributionAmount, Integer manyOfMemberShipFee, Double latePaymentPenalityInPercentage, LocalDate cycleStartDate, LocalDate cycleEndDate, Integer timesOfContributionForCredit) {
        this.id = id;
